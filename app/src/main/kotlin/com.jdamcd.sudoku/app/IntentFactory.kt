...
class IntentFactory
    ...
    constructor(
        ...
        fun getScoreboard(): Intent = Intent(context, ScoreboardActivity::class.java)
        ...
        fun getBookmarks(): Intent = Intent(context, BookmarksActivity::class.java)
        ...
        fun getLicenses(): Intent = Intent(context, LicensesActivity::class.java)
        ...
        companion object {
            ...
            fun isRandomShortcut(intent: Intent) =
                intent.hasExtra(EXTRA_SHORTCUT) &&
                    intent.getStringExtra(EXTRA_SHORTCUT) == ShortcutController.ID_RANDOM

            fun isResumeShortcut(intent: Intent) =
                intent.hasExtra(EXTRA_SHORTCUT) &&
