...
class PagerStripIndicator
    ...
    constructor(
        ...
        private fun initSystemAttributes(
            context: Context,
            attrs: AttributeSet,
        ) {
        ...
        override fun onDraw(canvas: Canvas) {
            ...
            rectPaint.color =
                ViewUtil.blendColours(colourAtPosition(currentPosition), colourAtPosition(currentPosition + 1), currentPositionOffset)
        ...
        private fun colourAtPosition(position: Int): Int = indicatorColours[position % indicatorColours.size]
