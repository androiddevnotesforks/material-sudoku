...
abstract class PuzzleView(
    ...
    protected var cellHeight: Float = 0f
    protected var padWidth: Float = 0f
    protected var padHeight: Float = 0f
    protected var digitX: Float = 0f
    protected var digitY: Float = 0f
    private var lineStroke: Float = 0f
    private var boxStroke: Float = 0f

    protected var isBorderless: Boolean = false

    protected lateinit var background: Paint
    protected lateinit var givens: Paint
